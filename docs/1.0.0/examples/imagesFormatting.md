---
layout: default
title: Image arrangement, Text formatting and color customization
parent: Examples
grand_parent: Version 1.0.0
nav_order: 3
---

Examples of diagnostics and answers with various image arrangements, text formatting and color customization.
